    ...
    public partial class firstmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "AddressId");
                    table.ForeignKey(
                        name: "FK_Clinics_Centers_CenterId",
                        column: x => x.CenterId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientClincs", x => new { x.PatientId, x.ClinicId });
                    table.ForeignKey(
                        name: "FK_PatientClincs_Clinics_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Clinics",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PatientClincs_Patients_PatientId",
                        column: x => x.PatientId,
